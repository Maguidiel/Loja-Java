...
//				produto.setPrecoCusto(it.getValorCusto());
	...
	public void setVendaRepositorio(VendaRepositorio vendaRepositorio) {
		this.vendaRepositorio = vendaRepositorio;
	}

	public ItemVendaRepositorio getItemVendaRepositorio() {
		return itemVendaRepositorio;
	}

	public void setItemVendaRepositorio(ItemVendaRepositorio itemVendaRepositorio) {
